...
---
```
The numeral or hash sign (#) indicates that the command 
needs to be run as root, whereas the dollar sign ($) shows 
that the command should be run as a regular user. 
```
...
```
##### STEP 3 ( Install Python 3.10.15, Update pip, Install virtualenv )
